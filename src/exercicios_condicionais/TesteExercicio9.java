        ...
        switch (numeroEscolha) {
            ...
            case 3: {
                ...
                if (somaDosKg > 8) {
                    ...
                    System.out.println("Você recebeu um desconto de 10% por estar comprando mais de 8KG em frutas ou mais que R$ 25,00 em frutas.");
                    ...
                    if (kgMaca > 5) {
                        if (kgMorango > 5) {
                            double resultadoDaCompraAmbosMaiorQue5 = (precoMacaAcimaDe5Kg * kgMaca) + (precoMorangoAcimaDe5Kg * kgMorango);
                            System.out.println("Você está comprando " + kgMaca + "kg de naça e " + kgMorango + "kg de morango.");
                            System.out.println("O valor da compra é de: " + resultadoDaCompraAmbosMaiorQue5);
                        }
                    }
                    if (kgMaca < 5) {
                        if (kgMorango > 5) {
                            double resultadoDaCompraMorangoMaiorQue5 = (precoMacaAbaixoDe5kg * kgMaca) + (precoMorangoAcimaDe5Kg * kgMorango);
                            System.out.println("Você está comprando " + kgMaca + "kg de naça e " + kgMorango + "kg de morango.");
                            System.out.println("O valor da compra é de: " + resultadoDaCompraMorangoMaiorQue5);
                        }
                    }
                    if (kgMaca > 5) {
                        if (kgMorango < 5) {
                            double resultadoDaCompraMacaMaiorQue5 = (precoMacaAcimaDe5Kg * kgMaca) + (precoMorangoAbaixoDe5kg * kgMorango);
                            System.out.println("Você está comprando " + kgMaca + "kg de naça e " + kgMorango + "kg de morango.");
                            System.out.println("O valor da compra é de: " + resultadoDaCompraMacaMaiorQue5);
                        }
                    }
                    if (kgMaca < 5) {
                        if (kgMorango < 5) {
                            double resultadoDaCompraAmbosMenoresQue5 = (precoMacaAbaixoDe5kg * kgMaca) + (precoMorangoAbaixoDe5kg * kgMorango);
                            System.out.println("Você está comprando " + kgMaca + "kg de naça e " + kgMorango + "kg de morango.");
                            System.out.println("O valor da compra é de: " + resultadoDaCompraAmbosMenoresQue5);
                        }
                    }
                }
                if (kgMaca > 5) {
